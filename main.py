...
class MainPage(webapp2.RequestHandler):
    def get(self):
        ...
        self.response.write("Hello, World!")#change to template.render(templateVars)) later
...
#         template = env.get_template("templates/profile.html")
        self.response.write("This is a profile page")#change to template.render(templateVars)) later
